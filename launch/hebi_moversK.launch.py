...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package=package_name,
            executable='hebi_arm_mover4',
            name='hebi_arm_mover4',
            parameters=joint_parameters
        ),
        ...
        Node(
            package=package_name,
            executable='hebi_arm_moverU0',
            name='hebi_arm_moverU0',
            parameters=joint_parameters
        ),

        Node(
            package=package_name,
            executable='hebi_arm_moverU1',
            name='hebi_arm_moverU1',
            parameters=joint_parameters
        ),
                
        Node(
            package=package_name,
            executable='hebi_arm_moverU2',
            name='hebi_arm_moverU2',
            parameters=joint_parameters
        ),
        
        Node(
            package=package_name,
            executable='hebi_arm_moverU3',
            name='hebi_arm_moverU3',
            parameters=joint_parameters
        ),
        
        Node(
            package=package_name,
            executable='hebi_arm_moverU4',
            name='hebi_arm_moverU4',
            parameters=joint_parameters
        ),
        
        Node(
            package=package_name,
            executable='hebi_j6_rotatorU1',
            name='hebi_j6_rotatorU1',
            output='screen',    
            parameters=joint_parameters
        ),  
        ...
        Node(
            package=package_name,
            executable='hebi_j6_rotatorU2',
            name='hebi_j6_rotatorU2',
            output='screen',    
            parameters=joint_parameters
        ), 
        ...
        Node(
            package=package_name,
            executable='hebi_j6_rotatorU3',
            name='hebi_j6_rotatorU3',
            output='screen',    
            parameters=joint_parameters
        ),         
