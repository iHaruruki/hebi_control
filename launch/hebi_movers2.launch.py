...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package=package_name,
            executable='hebi_j6_rotator3',
            name='hebi_j6_rotator3',
            output='screen',
            parameters=joint_parameters
        ),
        ...
        Node(
            package=package_name,
            executable='hebi_j6_rotator4',
            name='hebi_j6_rotator4',
            output='screen',
            parameters=joint_parameters
        ),
        ...
        Node(
            package=package_name,
            executable='hebi_j6_rotator5',
            name='hebi_j6_rotator5',
            output='screen',
            parameters=joint_parameters
        ),        
